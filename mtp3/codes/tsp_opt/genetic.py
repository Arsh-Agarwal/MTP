...
# import math, sys
# import random
# from tsp_opt.util import City, read_cities, write_cities_and_return_them, generate_cities
...
#         return (self.best_distance(), self.best_chromosome())
...
# def genalgo(cities):
#     cities = [City(a, b) for a, b in cities]
